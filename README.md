...
CI проверяет Python, синтаксис всех PowerShell-скриптов, компилирует оба Pawn-плагина и собирает установочный пакет. Код с клиентскими командами, киком или баном блокируется контрактом.
